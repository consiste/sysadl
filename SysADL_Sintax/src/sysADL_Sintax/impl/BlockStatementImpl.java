 ...
 * </p>
 * <ul>
 *   <li>{@link sysADL_Sintax.impl.BlockStatementImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockStatementImpl extends StatementImpl implements BlockStatement {
	...
	protected EClass eStaticClass() {
		return SysADLPackage.Literals.BLOCK_STATEMENT;
	}
	...
	public EList getBody() {
		if (body == null) {
			body = new EObjectContainmentEList(Statement.class, this, SysADLPackage.BLOCK_STATEMENT__BODY);
		}
		return body;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SysADLPackage.BLOCK_STATEMENT__BODY:
