 ...
 * </p>
 * <ul>
 *   <li>{@link sysADL_Sintax.impl.ForControlImpl#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForControlImpl extends EObjectImpl implements ForControl {
	...
	protected EClass eStaticClass() {
		return SysADLPackage.Literals.FOR_CONTROL;
	}
	...
	public EList getVars() {
		if (vars == null) {
			vars = new EObjectContainmentEList(ForVar.class, this, SysADLPackage.FOR_CONTROL__VARS);
		}
		return vars;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SysADLPackage.FOR_CONTROL__VARS:
